        ...
        <div class="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
            <div class="mx-auto max-w-lg text-center">
                <h1 onclick="location.href='/'" type="button"
                    class="cursor-pointer text-2xl font-bold text-indigo-600 sm:text-3xl">Login Your Account</h1>
            ...
            <form action="{{ route('login') }}" method="POST" class="mx-auto mb-0 mt-4 max-w-md space-y-4">
                @csrf
                <div>
                    ...
                    <div class="relative">
                        <input type="email" name="email" autocomplete="off"
                            class="w-full rounded-lg border-gray-200 p-3 pe-12 text-sm shadow-sm" placeholder="Enter email"
